...
void main() {
  group('ResponsiveSpacing Tests', () {
          ...
          home: Builder(
            builder: (context) {
              ...
              final verticalSpacing =
                  ResponsiveSpacing.getVerticalSpacing(context);
              ...
              final graphHeight = ResponsiveSpacing.getComponentHeight(
                  context, ComponentType.graph);
              ...
              expect(
                  calendarHeight, equals(852 * 0.15)); // 15% of screen height
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              expect(
                  calendarHeight, equals(1366 * 0.18)); // 18% of screen height
    ...
    testWidgets('Samsung Galaxy S20 Ultra spacing test (412x915)',
        (tester) async {
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              final actionButtonHeight = ResponsiveSpacing.getComponentHeight(
          ...
          MaterialApp(
            home: Builder(
              builder: (context) {
                ...
                final graphHeight = ResponsiveSpacing.getComponentHeight(
                    context, ComponentType.graph);
                final petHeight = ResponsiveSpacing.getComponentHeight(
                    context, ComponentType.pet);
                ...
                expect(
                    graphHeight,
                    greaterThan(
                        calendarHeight)); // Graph should be larger than calendar
            ...
            home: Builder(
              builder: (context) {
                ...
                if (previousHorizontalPadding != null) {
                  expect(horizontalPadding,
                      greaterThanOrEqualTo(previousHorizontalPadding!));
                }
                if (previousVerticalSpacing != null) {
                  expect(verticalSpacing,
                      greaterThanOrEqualTo(previousVerticalSpacing!));
                }
