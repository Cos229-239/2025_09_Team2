...
class _FlashcardStudyScreenState extends State<FlashcardStudyScreen> {
  ...
  void _loadCardState() {
    ...
    if (card.lastQuizAttempt != null) {
      setState(() {
        _selectedAnswer =
            card.lastQuizCorrect == true ? card.correctAnswerIndex : -1;
  ...
  // Removed individual card quiz functionality - only deck quizzes are allowed
  ...
  Future<void> _startDeckQuiz() async {
    ...
    setState(() {
      ...
      _showQuiz = true; // Show quiz interface
  ...
  Future<void> _answerDeckQuizQuestion(int selectedIndex) async {
    ...
    setState(() {
      ...
      _selectedAnswer =
          isSkipped ? null : selectedIndex; // Don't show selection for skipped
      _quizResult =
          isSkipped ? null : isCorrect; // Don't show result for skipped
    ...
    if (isCorrect) {
      questProvider
          .onPerfectScore(); // Each correct answer contributes to perfect score
    }
  ...
  void _exitDeckQuizMode() {
    setState(() {
      ...
      _showQuiz = false; // Hide quiz interface
  ...
  // Removed individual card quiz answer selection - only deck quizzes are allowed
  ...
  Widget _buildQuizInterface() {
    ...
    // Fallback to card interface if not in deck quiz mode
    ...
    return Column(
      ...
      children: [
        ...
        if (_selectedAnswer != null &&
            _currentQuizSession!.hasMoreQuestions) ...[
          const SizedBox(height: 16),
          ElevatedButton(
  ...
  void _showCompletionDialog() {
    final hasQuizCards = widget.deck.cards
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Ready to test your knowledge? Take the deck quiz to earn EXP for your pet!',
                        style: TextStyle(
                          color: Colors.blue.shade700,
        ...
        actions: [
          ...
          if (hasQuizCards)
            ElevatedButton.icon(
              onPressed: () {
                Navigator.of(context).pop(); // Close dialog
                _startDeckQuiz(); // Start the deck quiz
              },
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            if (_isDeckQuizMode) ...[
              ...
              Row(
                ...
                children: [
                  ...
                  // Show answer button (quiz functionality removed)
                  ElevatedButton.icon(
              ...
              // Deck quiz starter button - only show after completing the deck
              if (_currentCardIndex == widget.deck.cards.length - 1 &&
                  widget.deck.cards
                          .where(
                ...
                Center(
                  child: ElevatedButton.icon(
                    ...
                    icon: const Icon(Icons.quiz_outlined),
                    label: const Text('Take Deck Quiz'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.blue.shade600,
                      foregroundColor: Colors.white,
                      padding: const EdgeInsets.symmetric(
                ...
                Text(
                  'Test your knowledge with all ${widget.deck.cards.where((card) => card.multipleChoiceOptions.isNotEmpty).length} cards!',
                  style: TextStyle(
            ...
            // Removed individual card quiz controls - only deck quizzes are allowed
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      _currentCardIndex == widget.deck.cards.length - 1 &&
                              widget.deck.cards
                                      .where((card) =>
                                          card.multipleChoiceOptions.isNotEmpty)
                                      .length >=
                                  2
                          ? 'Tip: Complete the deck to unlock the quiz and earn EXP for your pet!'
