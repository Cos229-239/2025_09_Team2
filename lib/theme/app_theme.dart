...
class AppTheme {
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(    // Rounded corners for modern look
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8),       // Rounded corners
          borderSide: const BorderSide(color: Colors.blue, width: 2), // Blue border to show focus
        ),
      ),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,                                    // Enable background fill
        fillColor: Colors.grey.withValues(alpha: 0.1),  // Subtle grey background for dark mode
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8),       // Rounded corners
          borderSide: const BorderSide(color: Colors.blue, width: 2), // Blue focus border
        ),
      ),
