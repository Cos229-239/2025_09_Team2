...
class User {
  ...
  User({
    ...
    UserPreferences? preferences, // Optional, will use defaults
        ...
        preferences = preferences ??
            UserPreferences(); // Use default preferences if not provided
  ...
  Map<String, dynamic> toJson() => {
        ...
        'isEmailVerified':
            isEmailVerified, // Store verification status as boolean
        'createdAt': createdAt
            .toIso8601String(), // Convert DateTime to ISO string format
        'preferences':
            preferences.toJson(), // Convert preferences object to JSON
      };
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        isEmailVerified: json['isEmailVerified'] as bool? ??
            false, // Extract verification status
        createdAt: DateTime.parse(
            json['createdAt'] as String), // Parse ISO string to DateTime
        preferences: UserPreferences.fromJson(
            json['preferences'] as Map<String, dynamic>), // Parse preferences
      );
}
