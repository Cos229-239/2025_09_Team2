...
class Pet {
  ...
  Pet addXP(int amount) {
    ...
    while (newXP >= newLevel * 100) {      // While we have enough XP for next level
    ...
    return Pet(
      ...
      mood: _calculateMood(newLevel, newXP),             // Recalculate mood based on new stats
  ...
  factory Pet.fromJson(Map<String, dynamic> json) => Pet(
    ...
    species: PetSpecies.values.firstWhere(        // Find matching species enum
      (e) => e.toString() == json['species'],      // Compare string representations
    ...
    gear: List<String>.from((json['gear'] as List?) ?? []), // Convert gear to List<String>
    mood: PetMood.values.firstWhere(             // Find matching mood enum
