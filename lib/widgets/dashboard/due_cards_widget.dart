  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<SRSProvider, DeckProvider>(
      builder: (context, srsProvider, deckProvider, child) {
        final dueCount =
            srsProvider.dueCount; // Get count of cards due for review
        final totalCards = deckProvider
            .getAllCards()
            .length; // Get total number of cards across all decks
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment
                      .spaceBetween, // Space between title and badge
                  children: [
                    // Widget title
                    Text(
                      'Flashcard Review',
                ...
                if (dueCount == 0 && totalCards == 0)
                  ...
                  Container(
                    padding: const EdgeInsets.all(
                        24), // Generous padding for success state
                    child: Column(
                      children: [
                        ...
                        Text(
                          ...
                          style: Theme.of(context)
                              ...
                              ?.copyWith(
                                color:
                                    Colors.green, // Green color matching icon
                              ),
                        ),
                        const SizedBox(height: 8), // Spacing between messages
                  ...
                  Column(
                    children: [
                      ...
                      const SizedBox(
                          height: 12), // Spacing before action button
                      // Start review button
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors
                                .blue, // Blue background for action button
                            foregroundColor:
                      ...
                      Text(
                        ...
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(
                              color:
                                  Colors.grey, // Muted color for secondary info
                            ),
                      ),
                    ],
                  ),
