  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PetProvider>(
      builder: (context, petProvider, child) {
        final pet = petProvider.currentPet;        // Get current pet data from provider
              ...
              children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          LinearProgressIndicator(
                            value: pet.xpProgress,    // Progress value (0.0 to 1.0)
                          ...
                          const SizedBox(height: 4),   // Spacing after progress bar
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildStreakChip(context, petProvider.currentStreak),  // Study streak counter
                  ],
                ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () => petProvider.feedPet(),  // Trigger feeding action
                        icon: const Icon(Icons.food_bank, size: 16),  // Food icon
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () => petProvider.playWithPet(),  // Trigger play action
                        icon: const Icon(Icons.sports_esports, size: 16),  // Game controller icon
